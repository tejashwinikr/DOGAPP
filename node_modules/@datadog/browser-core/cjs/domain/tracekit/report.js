...
exports.traceKitWindowOnError = exports.unsubscribe = exports.subscribe = exports.report = void 0;
...
function report(ex) {
    ...
    var stack = computeStackTrace_1.computeStackTrace(ex);
...
function traceKitWindowOnError(message, url, lineNo, columnNo, errorObj) {
    var stack;
    if (lastExceptionStack) {
        computeStackTrace_1.augmentStackTraceWithInitialElement(lastExceptionStack, url, lineNo);
        processLastException();
    }
    else if (errorObj) {
        stack = computeStackTrace_1.computeStackTrace(errorObj);
...
function traceKitWindowOnUnhandledRejection(e) {
    ...
    var stack = computeStackTrace_1.computeStackTrace(reason);
