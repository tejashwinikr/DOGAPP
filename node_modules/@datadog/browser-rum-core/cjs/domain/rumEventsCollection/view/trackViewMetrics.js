...
function trackViewMetrics(lifeCycle, domMutationObservable, scheduleViewUpdate, loadingType, configuration) {
    var viewMetrics = {
        eventCounts: {
            errorCount: 0,
            longTaskCount: 0,
...
function trackActivityLoadingTime(lifeCycle, domMutationObservable, configuration, callback) {
    ...
    var stopWaitIdlePageActivity = trackPageActivities_1.waitIdlePageActivity(lifeCycle, domMutationObservable, configuration, function (params) {
