...
export declare const PRIVACY_ATTR_VALUE_MASK_FORMS_ONLY = "mask-forms-only";
...
export declare const PRIVACY_CLASS_MASK_FORMS_ONLY = "dd-privacy-mask-forms-only";
